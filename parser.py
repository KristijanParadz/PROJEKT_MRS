class Parser:
    ...
    def __init__(self, filename):
        ...
        self.poziv_Parse_Macros()
        if(not self._flag):
            Parser._error("MAC", self._line, self._errm)
            
        self.fix_Lines()
        
        for var in self._lines:
            print (var)
    ...
    from parseMacros import poziv_Parse_Macros, parse_Macros, handle_Destination, handle_Arg1
    from parseMacros import handle_Arg2, handle_cond, parse_Mult, parse_Pow, parse_Div
